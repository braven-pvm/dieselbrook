...
public partial class Sosptr
{
    ...
    [StringLength(10)]
    [Unicode(false)]
    public string Clineitem1 { get; set; } = null!;
    ...
    [StringLength(10)]
    [Unicode(false)]
    public string Cbin { get; set; } = null!;
    ...
    [Column("ncancelqty", TypeName = "numeric(16, 4)")]
    public decimal Ncancelqty { get; set; }
    ...
    [Column("nbprice", TypeName = "numeric(18, 4)")]
    public decimal Nbprice { get; set; }

    [Column("lcomponent")]
    public short Lcomponent { get; set; }
    ...
    [Column("lmultibin")]
    public short Lmultibin { get; set; }
