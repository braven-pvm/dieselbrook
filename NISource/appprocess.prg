************************************************************************
*PROCEDURE AppProcess
****************************
***  Function: Processes incoming Web Requests for AppProcess
...
loProcess = CREATEOBJECT("AppProcess", loServer)
...
*************************************************************
DEFINE CLASS AppProcess AS WWC_PROCESS
*************************************************************
...
LOCAL THIS as AppProcess OF AppProcess.prg
#ENDIF
 
*********************************************************************
* Function AppProcess :: OnProcessInit
************************************
...
THIS.StandardPage("Hello World from the AppProcess process",;
...
*** Select the Web Connection Log Table
IF !USED("CgiLog")  
   USE wwRequestLog ALIAS CgiLog
ENDIF
   
*** Run a query and pass the data to the script
SELECT TOP 10 * FROM CgiLog  ;
