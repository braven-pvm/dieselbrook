...
{
    public class OverriddenCookieAuthenticationService : CookieAuthenticationService
    {
        #region Fields
        ...
        public OverriddenCookieAuthenticationService(CustomerSettings customerSettings,
            ICustomerService customerService,
            IHttpContextAccessor httpContextAccessor) : base(customerSettings, customerService, httpContextAccessor)
        {
        ...
        public override async Task SignInAsync(Customer customer, bool isPersistent)
        {
            if (customer == null)
            ...
            #region 621 after register relogin issue fix 
